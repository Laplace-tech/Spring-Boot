...
//	}
//
//	Bean 등록 : @Bean 애너테이션으로 정의된 메서드는 Spring 컨테이너에 의해 관리되는 Bean을 생성함.
//	즉, SecurityConfig 클래스에서 정의된 PasswordEncoder는 Spring 컨테이너에 등록되고, 이 빈을
//	다른 클래스에서 사용할 수 있게 함.
//
...
// 	*** 사용자 조회 메서드 ***
	...
	public SiteUser getUser(String userName) {
		return this.userRepository.findByUserName(userName)
				.orElseThrow(() -> new DataNotFoundException("SITE_USER NOT FOUND"));
	}
